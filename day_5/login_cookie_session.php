...
if ($_POST['did_login']) {
	...
	$username_clean = strip_tags(trim($_POST['username']));
	$password_clean = strip_tags(trim($_POST['password']));
	...
	if ( $username_clean == $correct_username AND $password_clean == $correct_password ) {
