...
if( $_POST['did_delete'] == 1 ):
	//collect a list of all checked boxes
	$delete_array = $_POST['delete'];
	//check to see that array is not empty
	if( $delete_array != '' ):
		//go thru the list of IDs, deleting comments 1 at a time
...
<section class="panel">
		<?php 
		//get the title of and post ID of all posts written by the logged in user, that have comments
	...
	<form action="" method="post">
		...
		<?php 
		//make a handy variable for this post_id
